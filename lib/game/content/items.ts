...
export const items: ItemDefinition[] = [
  { id: 'vip-wristband', name: 'VIP wristband', description: 'Access all areas. Nobody has said which areas.', unlockHint: 'Starter item', icon: 'Ticket', color: '#ffd166', tilt: '-12deg', sortOrder: 10, tags: ['access'] },
  ...
  { id: 'golden-key', name: 'Golden key', description: 'Won from the signal. It opens something.', unlockHint: 'Lock the signal with a clean score.', icon: 'KeyRound', color: '#ffd166', tilt: '-8deg', sortOrder: 40, tags: ['access'] },
]
