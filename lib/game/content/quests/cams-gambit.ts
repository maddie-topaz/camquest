...
export const camsGambit: QuestDefinition = {
  ...
  status: "available",
  introduction:
    "Cam, a game of chance and choice has been set in motion." +
  ...
  steps: [
    {
      ...
      prompt:
        "The mysterious challenger has left two cartridges glowing in the dark." +
      ...
      cards: [
        {
          label: "Sun Cartridge",
          outcome: "Head to Pot Black and settle it over the pool table",
          icon: "Sun",
          summaryValue: "Sun",
        },
        {
          label: "Moon Cartridge",
          outcome: "Head to Planet Royale and battle it out in the arcade",
          icon: "Moon",
          summaryValue: "Moon",
        },
      ],
    },
    {
      ...
      summaryLabel: "Guide",
      prompt:
        "The match ends. Somewhere on the map, a new signal appears." +
    ...
    },
    {
      ...
      summaryLabel: "Fate",
      prompt:
        "You follow your guide to your destination and step inside." +
      ...
      cards: [
        {
          label: "Twin Fate",
          outcome: "Choose a cocktail for each other",
          icon: "Link",
          summaryValue: "Twin",
        },
        {
          label: "Wild Fate",
          outcome: "Roll the dice and let chance choose two cocktails",
          icon: "Dice5",
          summaryValue: "Wild",
          tags: ["dice-based"],
        },
    ...
    },
    {
      ...
      cards: [
        {
          label: "Glass Garden",
          outcome: "Go for a final drink at Terrarium",
          icon: "Martini",
        },
        {
          label: "Neon Jungle",
          outcome: "Go for a final drink at Hula Bula Bar",
          icon: "Palmtree",
        },
      ],
    },
  ...
  completionMessage:
    "The final choice locks into place. The screen goes dark. Then, one message appears:",
