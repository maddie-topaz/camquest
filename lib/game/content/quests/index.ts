...
export const quests: QuestDefinition[] = [unknownSignal, camsGambit];

export const questsBySlug: Record<string, QuestDefinition> = Object.fromEntries(
  quests.map((quest) => [quest.slug, quest]),
);
